...
Validação: testes unitários de status/prazo, compilação Android e testes locais de navegação, arraste, cancelamento, erro de conexão e integração de mensagens da interface.
